    ...
    public function admit_student(Request $request, $id)
    {
        ...
        if($resp != null and !is_string($resp)){
           if($resp->status == 1){
                ...
                // dd($phone_number);
                $message="Congratulations {$application->name}. You have been admitted into ".($chool_name??"HIMS")." for {$application->year->name} . Access your admission portal at https://apply.buibsystems.org to download your admission letter";
