    ...
    <table class="table table-stripped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="border">{{ \App\Models\ApplicationForm::where(['submitted', 1])->whereNotNull('transaction_id')->count() }}</td>
            ...
            @foreach ($programs as $prog)
                <tr>
                    ...
                    <td class="border">{{ \App\Models\ApplicationForm::where(['submitted', 1])->where('program', $prog->id)->whereNotNull('transaction_id')->count() }}</td>
