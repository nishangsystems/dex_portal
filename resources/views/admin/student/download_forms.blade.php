    ...
    <table class="table table-stripped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="border">{{ \App\Models\ApplicationForm::where(['submitted'=>1, 'year_id'=>$current_year])->whereNotNull('transaction_id')->count() }}</td>
            ...
            @foreach ($programs as $prog)
                <tr>
                    ...
                    <td class="border">{{ \App\Models\ApplicationForm::where(['submitted'=> 1, 'year_id'=>$current_year,'program'=> $prog->id])->whereNotNull('transaction_id')->count() }}</td>
