...
@section('section')
    ...
    <div class="py-2">
        <div class="bg-white px-3 py-1 d-flex flex-wrap justify-content-between">
            ...
            <div class="text-capitalize py-1 mx-1 my-2 px-3 rounded border" style="width: 45%; display: inline-block;"><span class="text-secondary" style="font-weight: 700;">email address<span> : <span class="text-dark" style="font-weight: 700;">{{ $application->email }}<span></div>
